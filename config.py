...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6337900438:AAEsK_FTBAbPDUH_xlo83_wNbDz0IYaxmPA")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "SB_LEECH_BOT") # Bot username without @.
